...
name: ${NAME}
summary: CIOP Server (Scientific Linux)
os:
  name: sl 
  version: 6
hardware:
...
VBoxManage modifyvm ${NAME} --nictype1 82540EM --macaddress1 08002793876A && \
VBoxManage modifyvm ${NAME} --natpf1 "Rule 1,tcp,,2222,,22" && \
VBoxManage modifyvm ${NAME} --nictype2 82540EM --macaddress2 080027E60A84 && \
